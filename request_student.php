                            ...
                            <div class="table-responsive">
                                ...
                                <th>Actions</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `student_request` where `status`=''";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td class="row text-white"><button type="submit" class='btn btn-primary'><a class="text-white" href="operations/status_accept.php?id=<?php echo $rows['id'];?>">Accept</a></button>  <button type="submit" name="accept_student" class='btn btn-danger my-2'><a class="text-white"  href="operations/status_denied.php?id=<?php echo $rows['id'];?>">Denied</a></button> </td>
                                        </tr>
                                        <?php
                                        }
                                       ?>
