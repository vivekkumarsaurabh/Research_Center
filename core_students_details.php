...
$sql1_e = "SELECT * FROM `student_request` WHERE `id`='$ids' ";
...
<div class="row align-items-center">
    <div class="col-sm-4 ">
        ...
        <img class="mx-4"  src="<?php echo $rows['pic_main']; ?>" height="250px" width="250px" alt="" style="border:2px solid brown; border-radius:50%;">
    </div>
    <div class="col-sm-4">
       <h4><?php echo $rows['name']; ?></h4> <br>
       <h6> Program :  <?php echo $rows['department']; ?></h6> <br>
       <h6> Group :  <?php echo $rows['categ']; ?></h6> <br>
