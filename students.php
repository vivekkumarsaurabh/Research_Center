...
if(isset($_SESSION['email'])){
    ...
    $categ = $_SESSION['department'];
    $pic = $_SESSION['main_pic'];
              ...
              <!----  <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                         ...
                         $records =mysqli_num_rows(mysqli_query($conn,"SELECT * From `student_request` where `status`='1' and `category`='' "));
                         $pagi = ceil($records/$per_page);

            
            $sql1 = "SELECT * FROM `student_request` where `status`='1' and `category`='' and `categ`='$categ' LIMIT $start,$per_page";
                                ...
                                //copy end
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td><button type="submit" class='btn btn-primary'><a class="text-white"  href="operations/core_access.php?id=<?php echo $rows['id'];?>">Core</a></button> <button type="submit" class='btn btn-danger'><a class="text-white" href="operations/status_denied.php?id=<?php echo $rows['id'];?>">Denied</a></button>  </td>
                                        ...
                                        //copy start
                                            ...
                                            ?>
                                            <h3 class="text-danger bold">No Records</h3>
                                            <?php
                                        }
                                        //copy end
                                       ?>
...
<!----copy start--->
  ...
  <ul class="pagination">
      <?php for ($i=1; $i<=$pagi; $i++) { 
          ...
          ?>
<li class="page-item active"><a class="page-link" href="javascript:void(0);" style="border:1px solid gray;"><?php echo $i ?></a></li>

<?php
          }
          else{
          ?>
          <li class="page-item <?php echo $class ?>" ><a class="page-link" href="?start=<?php echo $i ?>" style="border:1px solid gray;"><?php echo $i ?></a></li>
          <?php }?>
    <?php  }  ?>
