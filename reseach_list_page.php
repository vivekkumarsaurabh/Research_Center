...
<body>
  ...
  <div class="res text-center">
    <h3 style="text-align: center; border-bottom:2px solid brown;  display:inline-block;">RESEARCH</h3>
    <?php
include 'dbconn.php';
         
$sql1 = "SELECT * FROM `research` WHERE `category`='$category' AND `cat`='Research Paper' ";
...
?>
    <div class="resd">
      <h3>
        <?php echo $rows['r_title']; ?>
      </h3>
      <h5>
        <?php echo $rows['r_subtitle']; ?>
      </h5>
      <h5>Research Description</h5>
      <p>
        <?php echo $rows['r_desc']; ?>
      </p>
    </div>
