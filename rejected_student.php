                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Rejected Students</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Rejected Students</h1> 
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                          <!----   <div class="card-body">
                            ...
                            $sql1 = "SELECT * FROM `student_request` where `status`='0' and `category`='' AND `categ`='$categ'";
                            ...
                            {  
                                ...
                                <td class="row text-white"><button type="submit" class='btn btn-primary'><a class="text-white"  href="operations/status_accept.php?id=<?php echo $rows['id'];?>">Accept</a></button>  
                                <button type="submit"  class='btn btn-danger my-2'><a class="text-white" href="operations/delete_student.php?id=<?php echo $rows['id'];?>">DELETE</a></button>  
