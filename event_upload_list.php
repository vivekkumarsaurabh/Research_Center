                            ...
                            <div class="table-responsive">
                                ...
                                <th>Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `events` WHERE status='0' AND e_category='$categ'";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td><?php echo $rows['e_category'];?></td>
                                           
                                            <td> <button type="submit" class='btn btn-sm btn-danger'><a class="text-white" href="operations/status_eventHeld.php?id=<?php echo $rows['id'];?>">AlReady Held</a></button>
