                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Core Students List</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Core Students List</h1> 
                    </div>
                    <div class="col-6">
                            ...
                            <div class="table-responsive">
                                ...
                                <th>Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `student_request` where `status`='1' and `category`='core' AND `categ`='$categ'";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td> <button type="submit" class='btn btn-danger'><a class="text-white"  href="operations/core_to_student.php?id=<?php echo $rows['id'];?>">Denied</a></button> </td>
