                            ...
                            <div class="table-responsive">
                                ...
                                <th>Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `research` WHERE category='$categ' ";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td><?php echo $rows['rand_id'];?></td>
                                            <td><?php echo $rows['cat'];?></td>
                                            <td><?php echo $rows['r_title'];?></td>
                                            <td><?php echo $rows['r_subtitle'];?></td>
                                            <td><?php echo $rows['r_desc'];?></td>
