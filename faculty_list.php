                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Facuties Members</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Faculties Members</h1> 
                    </div>
                    <div class="col-6">
                            ...
                            <div class="table-responsive">
                                ...
                                <th>Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `facuties_member` WHERE `status`='1' AND categ='$categ'";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td><?php echo $rows['re_area'];?></td>
                                           
                                           
                                            <td><?php echo $rows['datetime']; ?></td>

                                            <td class="row text-white">
                                            <button type="submit" name="accept_student" class='btn btn-primary my-2'><a class="text-white"  href="faculties_edit_profile.php?id=<?php echo $rows['id'];?>">Edit</a></button> 
                                                <button type="submit" name="accept_student" class='btn btn-danger my-2'><a class="text-white"  href="operations/faculty_status_denied.php?id=<?php echo $rows['id'];?>">Delete</a></button> 
                                            </td>
