                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="profile.php" aria-expanded="false"><i
                                    ...
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="request_student.php" aria-expanded="false"><i class="mdi mdi-account-plus"></i><span
                                    ...
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="core_student.php" aria-expanded="false"><i class="mdi mdi-account-settings-variant"></i><span
                                            ...
                                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="member_student.php" aria-expanded="false"><i class="mdi mdi-account-star"></i><span
                                                    class="hide-menu">Member Students</span></a></li>
                                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            ...
                            <div class="table-responsive">
                                ...
                                <th>Choose Student</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `student_request` where `status`='1' and `category`=''";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            <td> <button type="submit" class='btn btn-danger'><a class="text-white" href="operations/status_denied.php?id=<?php echo $rows['id'];?>">Denied</a></button> </td>

                                            
                                            <td class="row text-white"><button type="submit" class='btn btn-primary'><a class="text-white"  href="operations/core_access.php?id=<?php echo $rows['id'];?>">Core</a></button>  <button type="submit" class='btn btn-danger my-2'><a class="text-white" href="operations/member_access.php?id=<?php echo $rows['id'];?>">Member</a></button> </td>
