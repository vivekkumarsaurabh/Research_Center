                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Request Students</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Request Students</h1> 
                    </div>
                    <div class="col-6">
                            ...
                            <div class="table-responsive">
                                ...
                                <th class="text-white">Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "SELECT * FROM `events` WHERE status='1' AND e_category='$categ'";
                                        ...
                                        while($rows = mysqli_fetch_assoc($result))
                                        {
                                          ...
                                          <?php  
                                           ...
                                           $_SESSION['ids'] = $ids;  ?>
                                            ...
                                            <td><?php echo $rows['e_title'];?></td>
                                            <td><?php echo $rows['es_date'];?></td>
                                            <td><?php echo $rows['ee_date'];?></td>
                                            <td><?php echo $rows['e_category']; ?>
                                        
                                        </td>
                                               
                                            <td>
                                        <form method="post" action="events_upload_pic.php" enctype="multipart/form-data">
                                        <input type="file" name="e_pic1">
                                        <input type="file" name="e_pic2">
                                        <input type="file" name="e_pic3">
                                        <input type="file" name="e_pic4">
                                        <input type="file" name="e_pic5">
